...
class APIs(BaseSection):
    kudago_url = StringField(default='https://kudago.com/public-api/v1.4/events/?lang=&page_size=100&fields=id,dates,title,place,slug,price&location=msk&actual_since={}')  # noqa: E501
    url_top_artists = StringField(default='http://ws.audioscrobbler.com/2.0/?method=user.gettopartists&user={user}&period=overall&limit={limit}&api_key={api_key}&format=json')  # noqa: E501
    url_recent_tracks = StringField(default='http://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user={user}&api_key={api_key}&format=json') # noqa: E501
